...
#set(COMMON_FLAGS                  "-m32 -march=i686 -fno-pie -ffreestanding -nostdlib -fbuiltin")
set(CMAKE_C_FLAGS                 "${COMMON_FLAGS} -mno-red-zone -fno-stack-protector -Wall -Wpedantic -Wextra -Werror -fstack-check")
